  ...
  return (
    ...
    >
      <Link href={`/article/${article.id}`}>
        ...
        >
          {article.isTop && (
            <div className="absolute top-3 right-3 z-10 px-2 py-0.5 text-xs rounded-full
          ...
          <div className="p-6">
            <div className="flex items-center gap-2 text-xs text-star-light/50 mb-3">
              ...
              {article.categoryName && (
                <><span>·</span><span>{article.categoryName}</span></>
              )}
            </div>
          ...
          <div className="absolute inset-0 opacity-0 group-hover:opacity-100
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-transparent via-star-light/5 to-transparent blur-xl" />
          </div>
        </article>
      </Link>
    </motion.div>
